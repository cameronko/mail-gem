  ...
  if (request.action === 'generateAIResponse') {
    (async () => {
      try {
        ...
        1. Ensure responses are always respectful, professional, and free from highly inappropriate, 
          racist, hateful, or offensive content. Do not generate or reference any highly inappropriate material, 
          including links to explicit or pornographic content.
        1.1. If an email thread contains highly explicit information (entry level explicit is okay), you must ignore that content when generating a response. 
